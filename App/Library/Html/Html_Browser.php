<?php
     ...
     * Last Modified: No 2013  , by dsphinx
     *
     * @version 1.9
     * @package PegasusPHP
     *
    ...
    class Browser extends  Input
    {
        ...
        /**
         *      Check if Browser is HTML5 compatible
         *
         *  (c) dsphinx
         *
         * @return bool
        ...
        public function HTML5()
        {
            ...
            switch ($this->getBrowser()) {
                case self::BROWSER_MOZILLA:         // IE 11 Mozilla Windows ?
                    if ($version >= 3) {
                        $html5_enable = TRUE;
                    }
                    break;
